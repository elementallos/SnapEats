 ...
 */
public class Imp3Controller implements Initializable {
    ...
    @FXML
    public void caricaCV(ActionEvent event){
        System.out.println("Loading <nome-cognome>_cv.txt --> ");
    }
    
    @FXML
    public void save(ActionEvent event) throws IOException {
        reset();
        System.out.println("Modifica effetuata!");
    }
