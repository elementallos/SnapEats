 ...
 */
public class P1_ImpiegatiController implements Initializable {
    ...
    public void mod(ActionEvent event) throws IOException {
        ...
        root = FXMLLoader.load(getClass().getResource("P1_Impiegati_ModificaImpiegato.fxml"));
    ...
    public void add(ActionEvent event) throws IOException {
        root = FXMLLoader.load(getClass().getResource("P1_Impiegati_AggiungiImpiegato.fxml"));
        stage = (Stage) ((MenuItem) event.getSource()).getParentPopup().getOwnerWindow();
        scene = new Scene(root);
        stage.setScene(scene);
        stage.show();
